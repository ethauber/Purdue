...
{
       0,   187,   187,   191,   192,   195,   199,   203,   204,   208,
     209,   213,   220,   221,   225,   246,   256,   257,   263,   271,
     279,   288,   297,   309,   312
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATGREATAMPERSAND", "LESS", "$accept", "goal", "commands", "command",
...
static const yytype_uint8 yystos[] =
{
      ...
      22,     6,     0,    16,     8,    23,    20,    19,     5,     7,
       9,    10,    11,    12,    24,    25,     3,    21,     3,     3,
       3,     3,     3,     6
};
...
#line 225 "shell.y" /* yacc.c:1646  */
    {
		if(strchr((yyvsp[0].string_val), '*') == NULL && strchr((yyvsp[0].string_val), '?') == NULL) {
			...
			expandWildcards(NULL, (yyvsp[0].string_val));
